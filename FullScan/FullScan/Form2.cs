...
namespace FullScan
{
    public partial class Form2 : Form
    {
        ...
        private void bt_path_Click_1(object sender, EventArgs e)
        {
        ...
        private void bt_testScanner_Click_1(object sender, EventArgs e)
        {
            Scan.StartScan();
        }
        ...
        private void pathBrowserDialog_HelpRequest(object sender, EventArgs e)
        {

        }

        private void check_useAdf_CheckedChanged(object sender, EventArgs e)
        {
            Program.config.ScanADF = check_useAdf.Checked;
            Program.config.Serialize();
        }
